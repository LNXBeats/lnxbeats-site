...
export default function ShopTermsPage() {
  return <LegalCandidateDocument document={releaseBShopTermsCandidate} introduction="Cadre candidat des ventes de produits physiques consolidant les décisions fiscales et logistiques, toujours soumis à revue juridique humaine." />;
}
