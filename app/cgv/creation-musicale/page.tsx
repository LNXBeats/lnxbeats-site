...
import { musicTermsCandidate } from "@/data/legal";
...
export default function MusicTermsPage() {
  return <LegalCandidateDocument document={musicTermsCandidate} introduction="Cadre candidat des créations musicales personnalisées, sans activation juridique ni transfert automatique de droits." />;
}
