...
Le montant de la licence publique, 150 €, dépasse 120 €. Les articles [L213-1](https://www.legifrance.gouv.fr/loda/article_lc/LEGIARTI000032226994/2024-03-24), [D213-1](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000032807208) et [D213-2](https://www.legifrance.gouv.fr/jorf/article_jo/JORFARTI000032798142) du Code de la consommation fondent la préparation d’un archivage de dix ans pour un contrat effectivement conclu. `retentionUntil` est donc prévu, mais reste nul pour les simples brouillons/acceptations QA tant que le workflow juridiquement validé ne définit pas le point de conclusion. Une future activation devra fixer la date, permettre un legal hold et préserver l’accès permanent. Les anciens dossiers à 1 500 € restent des traces historiques, pas une offre commercialisable.
