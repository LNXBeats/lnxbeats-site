...
test("tous les événements ont un template déterministe et versionné", () => {
  ...
  const kinds: OrderNotificationKind[] = [
    ...
    "CUSTOMER_RIGHTS_REJECTED", "CUSTOMER_RIGHTS_READY_FOR_PAYMENT",
    "CUSTOMER_RIGHTS_PAYMENT_CONFIRMED", "OWNER_RIGHTS_PAYMENT_CONFIRMED", "CUSTOMER_RIGHTS_LICENSE_ACTIVE",
    "CUSTOMER_RIGHTS_WITHDRAWAL_RECORDED", "OWNER_RIGHTS_WITHDRAWAL_REQUESTED", "CUSTOMER_RIGHTS_WITHDRAWAL_REFUNDED",
