...
test("storage key and Content-Disposition policies refuse traversal and header injection", () => {
  ...
  for (const extension of ["mp4", "mov", "m4v", "webm"]) {
    assert.doesNotThrow(() => assertMediaStorageKey(
      "private",
      `creations/quarantine/00000000-0000-4000-8000-000000000001/00000000-0000-4000-8000-000000000002/source.${extension}`,
    ));
  }
  assert.doesNotThrow(() => assertMediaStorageKey(
    "private",
    "creations/quarantine/00000000-0000-4000-8000-000000000001/00000000-0000-4000-8000-000000000002/video.mp4",
  ));
  assert.throws(() => assertMediaStorageKey(
    "private",
    "creations/quarantine/00000000-0000-4000-8000-000000000001/00000000-0000-4000-8000-000000000002/source.exe",
  ), MediaStorageError);
