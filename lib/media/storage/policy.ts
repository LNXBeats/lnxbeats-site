...
const privateKey = /^(?:orders\/[0-9a-f-]{36}\/(?:[0-9a-f-]{36}\.webp|deliveries\/[0-9a-f-]{36}\.(?:mp3|wav|flac|zip|pdf|jpg|png)|documents\/[0-9a-f-]{36}\.(?:zip|pdf))|shop-returns\/[0-9a-f-]{36}\/[0-9a-f-]{36}\.(?:jpg|png|webp)|creations\/quarantine\/[0-9a-f-]{36}\/[0-9a-f-]{36}\/video\.mp4)$/i;
