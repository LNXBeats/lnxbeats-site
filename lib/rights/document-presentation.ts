...
export function buildRightsDocumentSections(input: RightsDocumentPresentationInput): ContractPdfSection[] {
  ...
  return [
    ...
    { title: "11. Prix / rémunération", paragraphs: [`Prix unique de la licence : ${formatRightsCurrency(input.requestedPriceCents)}. Aucun paiement au titre de cette licence n’est ouvert à ce stade. Aucun droit n’est actif.`] },
    ...
    { title: "15. Entrée en vigueur", paragraphs: ["L’acceptation du présent projet ne suffit pas à rendre la licence active. La prise d’effet reste subordonnée à la validation juridique du modèle, à la validation de LNX Beats, aux acceptations traçables requises, au paiement intégral confirmé côté serveur, à la génération valide du document contractuel final et à l’expiration du délai légal de rétractation."] },
    { title: "16. Rétractation et commencement anticipé", paragraphs: ["Le consommateur dispose du délai légal de rétractation applicable aux contrats conclus à distance. Aucun commencement anticipé n’est automatique. S’il est proposé ultérieurement, il exige une demande expresse distincte, sans case précochée, et la reconnaissance distincte des conséquences légales applicables, conservées sur un support durable.", "La fonctionnalité en ligne de rétractation et les coordonnées de contact sont celles publiées par LNX STUDIO. Aucune clause du présent projet ne neutralise un droit légal."] },
    { title: "17. Retrait et fin de la licence", paragraphs: ["À l’expiration normale de la licence, ou après sa résolution dans les conditions légalement applicables, le client cesse les nouvelles exploitations et demande dans un délai raisonnable le retrait de la publication à son distributeur. Les délais techniques propres aux plateformes tierces peuvent subsister.", "En cas de manquement suffisamment grave, la résolution peut être demandée après une mise en demeure écrite restée sans effet pendant trente jours, sauf urgence ou règle impérative permettant une mesure plus rapide. Les conséquences financières dépendent des règles légales et de la situation effectivement exécutée."] },
    { title: "18. Responsabilité, droit applicable et litiges", paragraphs: ["Chaque partie répond de ses obligations dans les limites permises par la loi. Aucune clause ne prive le consommateur d’une garantie ou d’un recours impératif.", "Le contrat est soumis au droit français sans priver le consommateur de ses protections impératives. Une réclamation préalable peut être adressée à LNX Beats. En cas de désaccord persistant, le consommateur peut saisir gratuitement le médiateur indiqué dans les mentions légales, sans préjudice de son droit de saisir la juridiction compétente."] },
    { title: "19. Statut DRAFT / validation juridique", paragraphs: ["PROJET - NON ACTIF - VALIDATION JURIDIQUE EXTERNE REQUISE. Les clauses de rétractation, commencement anticipé, résolution, retrait, responsabilité et règlement des litiges doivent être approuvées dans une revue juridique référencée avant toute approbation du modèle ou ouverture commerciale."] },
  ];
}
