...
export const PUBLICATION_LICENSE_V4_CANONICAL_SHA256 = "1857b287154814f481129088611b8f71bb1fc3f5829f839dc1372f9b5f2cfee3";
...
export function isPublicationLicenseV4CanonicalSource(source: string) {
  return normalizedContractTemplateHash(source) === PUBLICATION_LICENSE_V4_CANONICAL_SHA256;
}
...
export const publicationLicenseV3DraftTemplate = `
