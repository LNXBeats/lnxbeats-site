...
export const notificationKindPresentation: Record<OrderNotificationKind, string> = {
  ...
  CUSTOMER_RIGHTS_PAYMENT_CONFIRMED: "Licence payée, délai de rétractation — client",
  OWNER_RIGHTS_PAYMENT_CONFIRMED: "Nouvelle licence payée — propriétaire",
  CUSTOMER_RIGHTS_LICENSE_ACTIVE: "Licence active — client",
  CUSTOMER_RIGHTS_WITHDRAWAL_RECORDED: "Rétractation enregistrée — client",
  OWNER_RIGHTS_WITHDRAWAL_REQUESTED: "Rétractation Rights — propriétaire",
  CUSTOMER_RIGHTS_WITHDRAWAL_REFUNDED: "Rétractation remboursée — client",
