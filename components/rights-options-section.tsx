...
export function RightsOptionsSection({
  ...
  if (!publication && !partnership) return null;
  return (
    <section className="order-detail__section rights-options" aria-labelledby="rights-options-title">
      ...
      <div className="rights-options__grid">
        {publication ? <article className="rights-option-card" aria-labelledby="rights-publication-title">
          <header className="rights-option-card__header">
            ...
            <strong className="rights-option-card__price">{formatEuro(publication.requestedPriceCents)}</strong>
          </header>
          ...
          <div className="rights-option-card__notice">
            ...
            <small>{rightsStatusPresentation[publication.status].label}. Aucun paiement n’est effectué à cette étape.</small>
          </div>
        </article> : null}
        {partnership ? <article className="rights-option-card rights-option-card--partnership" aria-labelledby="rights-partnership-title">
          <header className="rights-option-card__header">
            <p className="eyebrow">Partenariat d’exploitation</p>
            <h3 id="rights-partnership-title">Construire un projet de droits partagé</h3>
            <strong className="rights-option-card__price">{formatEuro(partnership.requestedPriceCents)}</strong>
          </header>
          ...
          <div className="rights-option-card__notice">
            <strong>{rightsStatusPresentation[partnership.status].label}.</strong>
